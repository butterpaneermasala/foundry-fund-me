...
# deploy-sepolia:
# 	forge script script/DeplyFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account defaultkey --sender 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
